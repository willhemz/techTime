...
const fortune = new URL('../../assets/images/fortune.png', import.meta.url).href

const bryce = new URL('../../assets/images/bryce.png', import.meta.url).href

export const data: PropsType[] = [
  {
    img: bella,
    name: 'Bella Moon',
